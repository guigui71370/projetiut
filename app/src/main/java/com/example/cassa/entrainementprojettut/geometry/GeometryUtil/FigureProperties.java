...
public enum FigureProperties {
    ...
    CARRE_P_2("Je possède 4 angles droits et 4 côtés égaux"),
    ...
    CERCLE_FP_2("Un point du cercle peut être plus éloingné du centre qu'un autre point de ce même cercle"),
    CERCLE_FP_3("Le diamètre est la distance entre un point du cercle et le centre du cercle."),

    //Losange
    LOSANGE_P_0("Je suis un losange"),
    LOSANGE_P_1("Je possède quatre côtés égaux"),
    ...
    RECTANGLE_P_3("Mes diagonales se coupent en leur milieu"),


    RECTANGLE_FP_0("Je suis un carré"),
    RECTANGLE_FP_1("Tous mes côtés sont de la même longueur"),
    ...
    //TriangleI
    TRIANGLEI_P_1("J'ai deux côtés de la même longueur"),
    TRIANGLEI_P_2("Je suis un triangle isocèle"),
    TRIANGLEI_P_3("Je possède un axe de symétrie"),

    TRIANGLEI_FP_1("J'ai trois côtés de la même longueur"),
