...
public class GeometryActivity extends GameActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        boolean answer;
        View buttonVrai = findViewById(R.id.activity_geometry_button_true);
        View buttonFaux = findViewById(R.id.activity_geometry_button_false);
        if( v == buttonVrai || v == buttonFaux){

            if( v == buttonVrai ) answer = true;
            else answer = false;
            if(answer == propertie){
