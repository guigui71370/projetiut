...
public class Niveau3 implements I_Niveau{


    private AppDatabase base;
    private EnglishWord recherche;
    public Niveau3(AppDatabase database) {
        base=database;
    ...
    public String[] GetGoodReponce() {
        return new String[]{recherche.getTraduction(),recherche.getEnglishWord(),recherche.getSong()+""};
    }
